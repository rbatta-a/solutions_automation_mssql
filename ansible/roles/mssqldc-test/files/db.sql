CREATE DATABASE [db1]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'db1', FILENAME = N'C:\Data1\data1\DatabaseFiles\MSSQL2019\db1.mdf' , SIZE = 8192KB , FILEGROWTH = 65536KB ),
...
( NAME = N'db1_4', FILENAME = N'C:\Data4\data4\db1_4.ndf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'db1_log', FILENAME = N'C:\Data5\data5\DatabaseLogs\MSSQL2019\db1_log.ldf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 -- WITH LEDGER = OFF
GO
