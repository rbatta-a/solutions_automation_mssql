pipeline {
    ...
    parameters {
        choice(choices: ['MySql','MSSQL_Test','MSSQLDC_Test','test_example','Postgres', 'Oracle','spark-dev', 'Commvault', 'cyberark3', 'Oracle-demo','k8s', 'Oracle-rac'], description: 'Select the Solution to build', name: 'solution')
