pipeline {
    ...
    parameters {
        choice(choices: ['MySql','MSSQL', 'Postgres', 'Oracle','spark-dev', 'Commvault', 'cyberark3', 'Oracle-demo','k8s', 'Oracle-rac', 'keerthi-ubuntu'], description: 'Select the Solution to build', name: 'solution')
